...
var style_SIG3LapakGIScomBatas_Kecamatan_BIG_PPBWPolygon25D_0 = function(feature, resolution){
    ...
    var value = feature.get("islam2021");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 12000.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 12000.000000 && value <= 24000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 24000.000000 && value <= 36000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 36000.000000 && value <= 49000.000000) {
            style = [ new ol.style.Style({
