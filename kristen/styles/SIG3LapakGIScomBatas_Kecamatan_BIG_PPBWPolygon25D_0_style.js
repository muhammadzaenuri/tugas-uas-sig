...
var style_SIG3LapakGIScomBatas_Kecamatan_BIG_PPBWPolygon25D_0 = function(feature, resolution){
    ...
    var value = feature.get("kristen2021");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 2300.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 2300.000000 && value <= 4600.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 4600.000000 && value <= 7000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 7000.000000 && value <= 8400.000000) {
            style = [ new ol.style.Style({
