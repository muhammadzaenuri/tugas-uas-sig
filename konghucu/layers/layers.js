...
lyr_SIG3LapakGIScomBatas_Kecamatan_BIG_PPBWPolygon25D_0.set('fieldAliases', {'kecamatan': 'kecamatan', 'kota': 'kota', 'konghc2020': 'konghc2020', 'konghc2021': 'konghc2021', });
lyr_SIG3LapakGIScomBatas_Kecamatan_BIG_PPBWPolygon25D_0.set('fieldImages', {'kecamatan': 'TextEdit', 'kota': 'TextEdit', 'konghc2020': 'TextEdit', 'konghc2021': 'TextEdit', });
lyr_SIG3LapakGIScomBatas_Kecamatan_BIG_PPBWPolygon25D_0.set('fieldLabels', {'kecamatan': 'inline label', 'kota': 'inline label', 'konghc2020': 'inline label', 'konghc2021': 'inline label', });
